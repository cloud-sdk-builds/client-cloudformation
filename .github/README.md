...
[`@aws-sdk/client-cloudformation`](https://www.npmjs.com/package/@aws-sdk/client-cloudformation/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudformation@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-98IASpZwuhY8CcBx4ZLLsDkz8yT90c+LEVEvXNOxdzVpW9MVkORWLTRIAUAg568r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudformation": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudformation@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudformation@3.650.0/index.min.mjs": "sha384-98IASpZwuhY8CcBx4ZLLsDkz8yT90c+LEVEvXNOxdzVpW9MVkORWLTRIAUAg568r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudformation/blob/refs/tags/3.650.0/LICENSE
```
