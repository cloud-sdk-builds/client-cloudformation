...
[`@aws-sdk/client-cloudformation`](https://www.npmjs.com/package/@aws-sdk/client-cloudformation/v/3.15.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudformation@3.15.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r+y+UGEuZqL3IfHyO+D62oAfGwuUZiCOZo82zDKqg2X6jysSN1WaY9LrHMN75oum
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudformation": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudformation@3.15.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudformation@3.15.0/index.min.mjs": "sha384-r+y+UGEuZqL3IfHyO+D62oAfGwuUZiCOZo82zDKqg2X6jysSN1WaY9LrHMN75oum"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudformation/blob/refs/tags/3.15.0/LICENSE
```
